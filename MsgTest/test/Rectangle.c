...
static int __pyx_pymod_exec_Rectangle(PyObject *__pyx_pyinit_module)
#endif
#endif
{
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "Rectangle")) {
      if (unlikely(PyDict_SetItemString(modules, "Rectangle", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Rectangle", 0, __pyx_lineno, __pyx_filename);
    }
