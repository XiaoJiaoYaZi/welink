...
class Ui_KafkaTool(object):
    def setupUi(self, KafkaTool):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/image/tools.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        KafkaTool.setWindowIcon(icon)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/image/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_fresh.setIcon(icon2)
        self.action_fresh.setObjectName("action_fresh")
        self.action_ReadMessage = QtWidgets.QAction(KafkaTool)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/image/type_list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ReadMessage.setIcon(icon3)
        self.action_ReadMessage.setObjectName("action_ReadMessage")
        self.action_findmessage = QtWidgets.QAction(KafkaTool)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/image/search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_findmessage.setIcon(icon4)
        self.action_findmessage.setObjectName("action_findmessage")
    ...
    def retranslateUi(self, KafkaTool):
        ...
        self.action_ReadMessage.setShortcut(_translate("KafkaTool", "Ctrl+L"))
        self.action_findmessage.setText(_translate("KafkaTool", "查找消息"))
        self.action_findmessage.setToolTip(_translate("KafkaTool", "查找某个消息"))
        self.action_findmessage.setShortcut(_translate("KafkaTool", "Ctrl+F"))
